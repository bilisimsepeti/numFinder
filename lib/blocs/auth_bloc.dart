...
class AuthBloc {
    ...
    if (_googleUser != null) {
      ...
      if (_googleAuth.idToken != null && _googleAuth.accessToken != null) {
        ...
        if (response.statusCode == 200) {
          ...
          jsonMAp = mapUserNumber;
          addStringToSF(jsonMAp["token"]);
          //print('json asagida');
          //print(jsonMAp["token"].toString());
  ...
  addStringToSF(jsonMAp) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.remove("stringValue");
    prefs.setString('stringValue', jsonMAp);
  }
  ...
  getStringValuesSF() async {
    ...
    print("Geldi Contact list  "+ stringValue.toString());
    return stringValue;
  }
